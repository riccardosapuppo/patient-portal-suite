...
```
dotnet test src/Portal.Tests            # 46 checks
...
| `Portal.Tests` | 46 checks: the archive asked directly, the portal driven over HTTP, three that hold the sign-in cards to the ward they describe, three that keep a browser from showing yesterday's stylesheet, four that are about the shape of the code rather than what it does, and one that holds this file to the number in this cell. |
